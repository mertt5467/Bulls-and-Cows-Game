...
This is a Java source code. You need to have Java JDK installed on your computer to compile and run it.
...
Bu bir Java kaynak kodudur. Çalıştırmadan önce bilgisayarınızda Java JDK kurulu olması gerekir.
